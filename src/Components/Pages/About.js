...
const About = () => {
    return (
        <>
        <div className='text-center py-10 bg-[#415791]'>
            <div className='container mx-auto px-16 py-16 text-[#fff]'>
        ...
        <div className='container mx-auto px-16 py-16'>
            <div className='text-[#fff]'>
                <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-10'>
                    ...
                    <div className='w-[100%] bg-[#415791] px-5'>
                ...
                <div className='flex flex-col lg:flex-row-reverse gap-10 py-24 text-[#fff]'>
                    <div className='w-[100%] lg:w-[50%]'>
                        <img src="/images/avatar.jpg" alt="" />
                    </div>
                    <div className='w-[100%] lg:w-[50%] bg-[#415791] px-5'>
